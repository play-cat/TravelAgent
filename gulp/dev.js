...
gulp.task('images:webp-dev', function () {
  return gulp
    .src([
      './src/img/**/*',
      '!./src/img/svgicons/**/*',
      '!./src/img/**/*.svg', // ⛔️ Виключаємо SVG
    ], { encoding: false })
...
gulp.task('images:dev', gulp.series('images:webp-dev', 'images:copy-dev'));
...
gulp.task('watch:dev', function () {
  ...
  gulp.watch('./src/json/**/*.json', gulp.parallel('json:dev'));
